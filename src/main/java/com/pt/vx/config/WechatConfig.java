...
public class WechatConfig {
     ...
     * appId
     */
    public static final String VxAppId = "wx1b38ab7610db2e5b";

    /**
     * 你的微信的密钥
     * appSecret
     */
    public static final String VxAppSecret = "1656834685d17f8b3304768dc6fed63c";
    ...
    static {
        userList.add(getUser(
                "oR1126oCty66XcOsIskax-t9fJPo", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "_VYKmBnfV0WqmjNNpqKcRsZ2E0_N1Xma-BpcBNZca3s", //要给这个人发送的模板ID
                "LYR", //咋称呼这个人
                "沙田区", //这个人的详细地址
                "香港" //这个人在的城市
        ));
